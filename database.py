...
def init_db():
    ...
    # Create prediction_sets table (NEW)
    cursor.execute("""
    ...
    # Create pool_prediction_set_assignments table (NEW)
    cursor.execute("""
    ...
    # Create predictions table (MODIFIED - now uses prediction_set_id and category_id)
    cursor.execute("""
    ...
    # Create category_results table (NEW - for tracking actual results)
    cursor.execute("""
